...
-   `compression` — The existing compression type when used in a SELECT query, or the desired compression type when used in an INSERT query.  The supported types are gz, br, xz, zst, lz4, and bz2.
